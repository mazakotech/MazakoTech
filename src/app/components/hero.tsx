...
const Hero = () => {
  return (
    <div className="relative flex content-center items-center justify-center bg-pic  mt-8 bg-top bg-contain md:bg-contain lg:bg-auto  sm:h-[450px] md:h-[500px] h-[300px] bg-no-repeat">
